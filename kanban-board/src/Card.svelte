...
<!-- Tarjeta del evento -->
<div class="card" class:no-tag={event.tags.length === 0} on:click={openDialog}>
	{event.name}
	<div class="tag-area">
...
<dialog bind:this={dialog}>
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<textarea bind:value={tempEvent.desc}></textarea>
				...
				<div class="tag-area">
					{#each tempTags as tag}
						<span class="editable-tag">
							{tag}
							<div class="delete-tag" on:click={removeTag(tag)}>
					...
					{/each}
					<span class="tag insert-tag" on:click={tagDialogRef.openDialog()}>
